...
class Sims(nn.Module):
    ...
    def forward(self, x):
        ...
        x = torch.einsum('nie,njf->nijef', (x, x))
...
class RepNet(nn.Module):
    def __init__(self, num_frames):
        ...
        self.transEncoder1 = TransEncoder(d_model=512, n_head=4, dropout = 0.2, dim_ff=512, num_layers = 2)
        self.transEncoder2 = TransEncoder(d_model=512, n_head=4, dropout = 0.2, dim_ff=512, num_layers = 2)
    ...
    def forward(self, x, ret_sims = False):
        ...
        x = x.view(batch_size, 64, self.num_frames, 7, 7)
